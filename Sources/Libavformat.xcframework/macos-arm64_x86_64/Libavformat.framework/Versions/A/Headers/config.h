...
#define FFMPEG_CONFIGURATION "--prefix=/Users/kintan/Documents/Github/TracyPlayer/Modules/FFmpegKit/.Script/FFmpeg/macos/thin/x86_64 --disable-armv5te --disable-armv6 --disable-armv6t2 --disable-bzlib --disable-gray --disable-iconv --disable-linux-perf --disable-shared --disable-small --disable-swscale-alpha --disable-symver --disable-xlib --enable-cross-compile --enable-optimizations --enable-pic --enable-runtime-cpudetect --enable-static --enable-thumb --enable-version3 --pkg-config-flags=--static --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-avcodec --enable-avformat --enable-avutil --enable-network --enable-swresample --enable-swscale --disable-devices --disable-outdevs --disable-indevs --disable-postproc --enable-indev=lavfi --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-muxers --enable-muxer=flac --enable-muxer=dash --enable-muxer=hevc --enable-muxer=iamf --enable-muxer=m4v --enable-muxer=matroska --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=mpegts --enable-muxer=nut --enable-muxer=vvc --enable-muxer='webm*' --disable-encoders --enable-encoder=aac --enable-encoder=alac --enable-encoder=flac --enable-encoder='pcm*' --enable-encoder=movtext --enable-encoder=mpeg4 --enable-encoder=prores --enable-protocols --enable-bsfs --disable-filters --enable-filter=aformat --enable-filter=amix --enable-filter=anull --enable-filter=aresample --enable-filter=areverse --enable-filter=asetrate --enable-filter=atempo --enable-filter=atrim --enable-filter=boxblur --enable-filter=bwdif --enable-filter=delogo --enable-filter=equalizer --enable-filter=estdif --enable-filter=firequalizer --enable-filter=format --enable-filter=fps --enable-filter=gblur --enable-filter=hflip --enable-filter=hwdownload --enable-filter=hwmap --enable-filter=hwupload --enable-filter=idet --enable-filter=lenscorrection --enable-filter='lut*' --enable-filter=negate --enable-filter=null --enable-filter=overlay --enable-filter=palettegen --enable-filter=paletteuse --enable-filter=pan --enable-filter=rotate --enable-filter=scale --enable-filter=setpts --enable-filter=superequalizer --enable-filter=transpose --enable-filter=trim --enable-filter=vflip --enable-filter=volume --enable-filter=w3fdif --enable-filter=yadif --enable-filter=avgblur_vulkan --enable-filter=blend_vulkan --enable-filter=bwdif_vulkan --enable-filter=chromaber_vulkan --enable-filter=flip_vulkan --enable-filter=gblur_vulkan --enable-filter=hflip_vulkan --enable-filter=nlmeans_vulkan --enable-filter=overlay_vulkan --enable-filter=vflip_vulkan --enable-filter=xfade_vulkan --disable-debug --enable-stripping --arch=x86_64 --target-os=darwin --enable-libxml2 --enable-neon --enable-asm --enable-videotoolbox --enable-audiotoolbox --enable-filter=yadif_videotoolbox --enable-filter=scale_vt --enable-filter=transpose_vt --enable-encoder=h264_videotoolbox --enable-encoder=hevc_videotoolbox --enable-encoder=prores_videotoolbox --enable-ffplay --enable-sdl2 --enable-decoder=rawvideo --enable-filter=color --enable-filter=lut --enable-filter=testsrc --enable-filter=drawtext --enable-debug --enable-debug=3 --disable-stripping --enable-outdev=audiotoolbox --enable-indev=avfoundation --enable-libshaderc --enable-vulkan --enable-lcms2 --enable-libdav1d --enable-decoder=libdav1d --enable-libplacebo --enable-filter=libplacebo --enable-libfreetype --enable-libharfbuzz --enable-libfribidi --enable-libass --enable-filter=ass --enable-filter=subtitles --enable-gmp --enable-gnutls --enable-libsrt --enable-protocol=libsrt --enable-libzvbi --enable-decoder=libzvbi_teletext --enable-libfontconfig --enable-libbluray --enable-libopus"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2024
#define FFMPEG_DATADIR "/Users/kintan/Documents/Github/TracyPlayer/Modules/FFmpegKit/.Script/FFmpeg/macos/thin/x86_64/share/ffmpeg"
#define AVCONV_DATADIR "/Users/kintan/Documents/Github/TracyPlayer/Modules/FFmpegKit/.Script/FFmpeg/macos/thin/x86_64/share/ffmpeg"
